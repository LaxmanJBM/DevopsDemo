...
//			private WebElement qty;
		...
		//REVENUE AND COST DETAILS
			...
			public void verifyBasicDetails(int excel) throws Exception {
			  ...
			  FileInputStream file5=new FileInputStream("C:\\Users\\Admin\\eclipse-workspace\\B\\Test_Data\\Test_Data.xlsx");	
		...
		//SELECT DROPDOWN
				Thread.sleep(800);
				FileInputStream file6=new FileInputStream("C:\\Users\\Admin\\eclipse-workspace\\B\\Test_Data\\Test_Data.xlsx");
				Sheet excelSheet = WorkbookFactory.create(file6).getSheet("basicDetails");
	...
	/*		try {
		...
		//Scroll upto top 
			...
			public void verifyServiceDetails(int excel) throws Exception {                 
				 ...
				 FileInputStream file7=new FileInputStream("C:\\Users\\Admin\\eclipse-workspace\\B\\Test_Data\\Test_Data.xlsx");	
		...
		//CFS
			...
			public void verifyAdditionalDetails(int excel) throws Exception {                 
				 ...
				 FileInputStream file8=new FileInputStream("C:\\Users\\Admin\\eclipse-workspace\\B\\Test_Data\\Test_Data.xlsx");	
		...
		//Scrolling		
				...
				FileInputStream file1=new FileInputStream("C:\\Users\\Admin\\eclipse-workspace\\B\\Test_Data\\Test_Data.xlsx");	
				...
				//WE CAN ADD MULTIPLE PACKING MATERIAL IN SINGLE BOOKING 	
					...
					public void allVehiPackingList(int excel) throws Exception         
					{
				        ...
				        FileInputStream file4=new FileInputStream("C:\\Users\\Admin\\eclipse-workspace\\B\\Test_Data\\Test_Data.xlsx");	
				...
				/*		Thread.sleep(1500);
						...
						FileInputStream file=new FileInputStream("C:\\Users\\Admin\\eclipse-workspace\\B\\Test_Data\\Test_Data.xlsx");	
			...
			try {
					...
					try {
						if(driver.switchTo().alert().getText().contains("Do you want to continue editing?Y/N")) {
					driver.switchTo().alert().accept();}}
					catch(Exception e) {Thread.sleep(1500);}
					//Do you want to continue editing?Y/N
//This is for Successful Booking Code...
				//	 Thread.sleep(1500);
				//	 System.out.println("What is the text2 msg ="+ text2.getText());
				...
				else if(text2.getText().contains("* Booking Saved Successfully")) {
					 Thread.sleep(1500);                 
					   close1.click();
			...
			try {
					...
					//	 Thread.sleep(1500);
					//		System.out.println("What is the text2 msg ="+ mass1);
				...
				//		 if(text2.getText().contains("* Booking Saved Successfully")) {        //* Booking Saved Successfully CHN/BKG/AFE/00025/23-24
							   ...
							   WebElement close1 = driver.findElement(By.xpath("//a[@href='javascript:flshmsgrclose();']"));
							   close1.click();
							  
							   Thread.sleep(1500);			
						      	 WebElement ppClose = driver.findElement(By.xpath("//input[@name='ctl00$ContentPlaceHolder1$imgclosediv']"));
						      	ppClose.click();
						      
						      	Thread.sleep(1500); 	
								 WebElement undo = driver.findElement(By.xpath("//img[@id='ctl00_btnCancel']"));
								 undo.click();
								
								 Thread.sleep(1500);
								 WebElement newBt = driver.findElement(By.xpath("//img[@id='ctl00_btnNew']"));
								 newBt.click();
							//      JavascriptExecutor executor = (JavascriptExecutor) driver;     //Not Work
						   	//      executor.executeScript("arguments[0].click();", close1);
									
							//		flshmsgrclose();  //Not Work
									
									
							//		((JavascriptExecutor)driver).executeScript("$.flashMessenger.close()");    //Not Work
				...
				public void verifySaveBtn(int excel) throws Exception {	
...
//This is for Booking failed  Code...									
							String errormass = text3.getText();
							System.out.println("What is the text3 msg ="+errormass);
							String errMass = "* Booking updation failed. Please refer the error details.";
								if(text3.getText().contains("* Booking updation failed. Please refer the error details.")) {	 
									//	 JOptionPane.showMessageDialog(null, "*Booking updation failed. Please refer the error details."+ exec);
										 Thread.sleep(1500);
										WebElement close2 = driver.findElement(By.xpath("//*[@id=\"fmBox\"]/a"));
										close2.click();
						...
						/*	 if(text2.getText().contains("*   Booking Saved Successfully")) {
										//	JOptionPane.showMessageDialog(null, "Booking Saved Successfully"+ exec);
									
										Thread.sleep(2000);
											WebElement close1 = driver.findElement(By.xpath("//*[@id=\"fmBox\"]/a"));
											close1.click();}
								}
								catch(NoAlertPresentException e) {Thread.sleep(1500);}*/
				...
				/*	 Thread.sleep(1500);
					...
					//	String text1 = " Booking Saved Successfully";
						...
						if(text2.getText().contains("Booking Saved Successfully")) {
							JOptionPane.showMessageDialog(null, "Booking Saved Successfully"+ exec);
							Thread.sleep(1500);
							WebElement close1 = driver.findElement(By.xpath("(//a[text()='Close'])[2]"));
							close1.click();}
						
						
					//	 JavascriptExecutor js = (JavascriptExecutor) driver;
					//	 String TitleName = js.executeScript("return document.title;").toString();      //To get text by using the JavaScriptExcecutors 
					//	System.out.println("title ="+TitleName);
						...
						String errMass = "* Booking updation failed. Please refer the error details.";
						 ...
						 if(text3.getText().contains(errMass)) {	 
						//	 JOptionPane.showMessageDialog(null, "*Booking updation failed. Please refer the error details."+ exec);
							 Thread.sleep(1500);
							WebElement close2 = driver.findElement(By.xpath("//div[@id='closeBtn']"));
							close2.click();
							Thread.sleep(1500);
							WebElement errorIcon = driver.findElement(By.xpath("//img[@id='ctl00_ImgErrVal']"));
							 JavascriptExecutor executor = (JavascriptExecutor) driver;
						     executor.executeScript("arguments[0].click();", errorIcon);
							}
						
						 
						 
						 
						 String chrgMsg = "*Please update following fields * Chrg. WT/Frt. Tones"; 
						 if(chrgMass.getText().contains(chrgMsg)) {
							 JOptionPane.showMessageDialog(null, "*Please update following fields * Chrg. WT/Frt. Tones"+ exec);
							 Thread.sleep(1500);
							 JavascriptExecutor executor = (JavascriptExecutor) driver;
						     executor.executeScript("arguments[0].click();", close2);
						     Thread.sleep(1000);
						     basicBtn.click();  
		...
		/*			Thread.sleep(1500);
					...
					//		 WebElement saveButton = wait.until(ExpectedConditions.elementToBeClickable(By.id("closeBtn")));
							 WebElement flashErrorMessage = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[contains(text(), '*Booking updation failed. Please refer the error details.')]"))); 
							 flashErrorMessage.findElement(By.xpath("(//a[text()='Close'])[2]")).click();
							 Thread.sleep(1500);
								warningMsg.click();}*/
